...
export default function RegisterPage() {
    ...
    return (
        <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-slate-50 via-indigo-50/40 to-cyan-50/30 dark:from-gray-950 dark:via-indigo-950/30 dark:to-gray-950 flex items-center justify-center p-4">
            {/* Background blobs */}
            <div className="absolute top-[-15%] left-[-10%] w-[400px] h-[400px] rounded-full bg-gradient-to-br from-purple-300/30 to-pink-400/20 blur-[100px] animate-blob" />
            <div className="absolute bottom-[-15%] right-[-8%] w-[350px] h-[350px] rounded-full bg-gradient-to-br from-blue-300/20 to-cyan-400/15 blur-[100px] animate-blob" style={{ animationDelay: '3s' }} />
                ...
                <Card className="premium-card rounded-3xl overflow-hidden">
                    ...
                    <CardBody className="p-10">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Start building amazing forms</p>
                        </div>
